        ...
        return (
            <div className='header-container'>
                <Navbar variant="dark" bg="dark" expand="lg">
                    <Navbar.Brand href="/member"><img alt="navbar-brand" width="32" height="32" className="d-inline-block align-top rotating-logo" src={asteriskilogo}></img> Jäsenrekisteri</Navbar.Brand>

...
import { memberDetailsAction, memberUpdateAction } from '../../../actions/membersActions';
...
class MemberDetailsUpdateComponent extends Component {
    ...
    componentDidMount() {
        this.props.dispatch(memberDetailsAction({ memberID: this.props.match.params.id }));
    }
    ...
    onHandleUpdateMember = (event) => {
        ...
        const data = {
            firstName, lastName, utuAccount, email, hometown, tyyMember, tiviaMember, role, password, passwordAgain, _id
        };
